...
## Project Structure
    ...
    ├── testapiautosetting_123021  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_123021`
...
2. Clone this repo and `cd testapiautosetting_123021`
